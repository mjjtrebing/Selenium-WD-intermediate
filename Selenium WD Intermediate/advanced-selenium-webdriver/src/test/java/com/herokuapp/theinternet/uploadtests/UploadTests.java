...
public class UploadTests extends TestUtilities {
	...
	@Test(dataProvider = "fileSource")
	public void fileUploadTest(int testNum, String fileName) {
		log.info("Starting fileUploadTest #" + testNum + " for " + fileName);
		...
		// Select file
		//String fileName = "Program Humor.jpg";
